    ...
    public class TargetMover : MonoBehaviour
    {
        ...
        public void UpdateTargetPosition()
        {
            ...
            else
            {
                ...
                //	positionFound = true;
                //}
                if (CheckGroundPosition(cam, out hit))
                {
                    newPosition = hit.point;
                    positionFound = true;
                }
            ...
            if (positionFound && newPosition != targetPos)
            {
        ...
        public static bool CheckGroundPosition(Camera camera, out RaycastHit hit)
        {
            RaycastHit[] hits = new RaycastHit[10];
            Physics.RaycastNonAlloc(camera.ScreenPointToRay(Input.mousePosition), hits);
            hit = default;
